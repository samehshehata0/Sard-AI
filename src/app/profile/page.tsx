        ...
        <Card>
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="font-heading text-2xl font-black text-foreground">Sameh</h2>
                <p className="mt-1 text-sm font-bold text-muted-foreground">طالب معلم</p>
              </div>
            </div>
            <ArabicButton icon={<Edit3 className="h-4 w-4" />}>تعديل الملف الشخصي</ArabicButton>
          </div>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <Info label="البريد الإلكتروني" value="sameh@university.edu" />
            <Info label="الدور" value="طالب معلم" />
            <Info label="المؤسسة" value="كلية التربية" />
          </div>
        </Card>
      </div>
    </AppShell>
